@extends('pages.writer.panel')
@section('panel')
<h3 class="display-4 float-left">Moje posty</h3>
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <div class="modal-body">
            <form action="/writer/posts/create" method="post">
              @csrf
              <input type="hidden" value='writer' name="rola">
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <div class="modal-body">
                    <form id="edit_data" action="/writer/posts/edit" method="post">
                      @csrf
                      <div class="form-group">
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Zamknij</button>
                    <a href="/writer/posts/delete/{{$data->id}}"><button type="button" class="btn btn-danger">Usuń</button></a>
                  </div>
                  </div>
                </div>
</div>
